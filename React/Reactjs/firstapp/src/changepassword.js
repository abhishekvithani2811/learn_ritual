    ...
    SaveCategory = (e) => {
        {
            ...
            var url = "http://127.0.0.1:5000/register_user/"+ this.state.email +"/"+ this.state.newpassword +"/"+this.state.oldpassword +"/"+this.state.conformpassword;
            console.log(url);
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-12">
                                    <h2 className="font-weight-bold mb-4 text-center">Change Password</h2>
